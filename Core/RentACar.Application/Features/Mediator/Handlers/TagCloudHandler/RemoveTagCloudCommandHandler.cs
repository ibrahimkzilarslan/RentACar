...
{
    public class RemoveTagCloudCommandHandler : IRequestHandler<RemoveTagCloudCommands>
    {
        ...
        public async Task Handle(RemoveTagCloudCommands request, CancellationToken cancellationToken)
        {
