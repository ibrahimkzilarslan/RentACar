...
{
    public class RemoveTestimonialCommandHandler : IRequestHandler<RemoveTestimonialCommands>
    {
        ...
        public async Task Handle(RemoveTestimonialCommands request, CancellationToken cancellationToken)
        {
