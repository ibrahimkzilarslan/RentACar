...
{
    public class RemoveBlogCommandHandler : IRequestHandler<RemoveBlogCommands>
    {
        ...
        public async Task Handle(RemoveBlogCommands request, CancellationToken cancellationToken)
        {
